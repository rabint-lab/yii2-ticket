...
/** @var \rabint\ticket\models\TicketBody $newTicket */
/** @var \rabint\ticket\models\TicketBody $thisTicket */
/** @var \rabint\ticket\models\TicketFile $fileTicket */
            ...
            <div class="collapse" id="collapseExample">
                <div class="well">
                    ...
                    <?= $form->field($newTicket,
                        'text')->textarea(['style' => 'height: 150px; resize: none;'])->label('متن پیام')->error() ?>
